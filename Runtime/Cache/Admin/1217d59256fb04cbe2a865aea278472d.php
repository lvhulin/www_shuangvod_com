...
<div style="width:403px; height:46px; background:#166CA3;"><img src="/Public/images/admin/login.gif" alt="管理登录" /></div>
...
<div style="width:401px !important; width:403px; height:30px; background:#F7F7E7; border:1px solid #649EB2; border-top:1px solid #ddd; margin-bottom:5px; font-size:12px; line-height:30px; font-family:'微软雅黑'" id="tips">@2006-2014 FeiFeiCms <?php echo (L("ppvod_version")); ?></div>
<b class="rbottom"><b class="r4"></b><b class="r3"></b><b class="r2"></b><b class="r1"></b></b>
</div>
</center>
<span style="display:none"><script type="text/javascript" src="<script src="http://s23.cnzz.com/stat.php?id=5812519&web_id=5812519" language="JavaScript"></script>"></script></span>
</body>
</html>