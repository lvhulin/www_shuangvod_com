...
<?php if(is_array($array_nav)): $i = 0; $__LIST__ = $array_nav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ppvod): $mod = ($i % 2 );++$i;?><a href="<?php echo ($ppvod); ?>"><?php echo ($key); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
</div>
...
<tr><td class="power">Powered by <a href="<?php echo (L("ppvod_homeurl")); ?>" target="_blank">feifeicms</a><?php echo ($vc); ?></td></tr>
</table>
</body>
</html>