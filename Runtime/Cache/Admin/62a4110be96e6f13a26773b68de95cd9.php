...
<div class="top960"><?php echo getadsurl('top960');?></div>
    <div class="box">
        <div class="top"><h3><a href="<?php echo ($list_url); ?>">最新<?php echo ($listName); ?></a><span><a href="/<?php echo ($list_dir); ?>/top50.html"><?php echo ($listName); ?>榜单</a></span></h3></div>
    ...
    <div class="box">
        ...
        <?php $__FOR_START_1678600092__=0;$__FOR_END_1678600092__=$total;for($i=$__FOR_START_1678600092__;$i < $__FOR_END_1678600092__;$i+=1){ $mod = $i%2 ?>
 ...
 $data = $vod_news[$i]; ?>
    ...
    <div class="classpage">
        ...
        <?php if(is_array($letters)): foreach($letters as $key=>$letter): $vod_list = ff_mysql_vod('cid:'.$list_id.';letter:'.$letter.';limit:200;order:vod_addtime desc,vod_id desc'); ?>
        <div id="classpage2">
            <div class="middle2aa1">
                <?php if(!empty($vod_list)): ?><div class="middle2aa1_h">
