...
<body><?php $vod_stars = ff_mysql_vod('limit:14;stars:5;order:vod_hits desc'); $vod_news = ff_mysql_vod('limit:36;order:vod_addtime desc'); $vod_hot_tv = ff_mysql_vod('limit:21;cid:2;order:vod_baiid desc'); $vod_hot_dm = ff_mysql_vod('limit:10;cid:3;order:vod_baiid desc'); $vod_hot_dy = ff_mysql_vod('limit:10;cid:1;order:vod_baiid desc'); ?>
<div class="wrap">
    <div class="topbar">
...
<div class="box">
 ...
 <div class="box">
    <div class="top"><h3><span>今天到目前已更新<strong><?php echo getcount(999);?></strong>部</span><a href="<?php echo ff_mytpl_url('my_new.html');?>">最新更新节目</a></h3></div>
     ...
     <?php $__FOR_START_1159479790__=0;$__FOR_END_1159479790__=$total;for($i=$__FOR_START_1159479790__;$i < $__FOR_END_1159479790__;$i+=1){ $mod = $i%2 ?>
