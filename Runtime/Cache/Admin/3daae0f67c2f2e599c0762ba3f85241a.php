...
<head>
<title>热门影片-<?php echo ($sitename); ?></title>
...
<div class="top960"><?php echo getadsurl('top960');?></div>
	<div class="top960"><?php echo getadsurl('top960');?></div>
     <div class="box">
        <h3><span>今天到目前已更新<strong><?php echo getcount(999);?></strong>部</span><label><a href="news.shtml">最新更新节目</a></label></h3>
    	...
    	<?php if(($mod) == "0"): ?></ul><?php if(in_array(($i), explode(',',"8,16,24,32,40,48,56,64,72,80,88,96"))): ?><ul class="hang1"><?php else: ?><ul class="hang2"><?php endif; endif; endforeach; endif; else: echo "" ;endif; ?></ul>
    </div>
    <div class="ft">
    <div class="ft_l">
