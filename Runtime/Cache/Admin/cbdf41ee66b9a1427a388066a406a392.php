...
<title>Top</title>
<link rel='stylesheet' type='text/css' href='/Public/css/admin-top.css' />
...
<body>
<div class="logo"><img src="/Public/images/admin/top_logo.gif"></div>
<div class="tabs" id="topmenu">
	...
	<li><a href="http://www.feifeicms.cc" target="right" onClick="Tabs(this,8)"><span>飞飞cms官方论坛</span></a></li>
</div>
<div class="tophr">
	<div class="left">你好：<?php echo (session('admin_name')); ?>，<?php echo (L("ppvod_welcome")); ?></div>
