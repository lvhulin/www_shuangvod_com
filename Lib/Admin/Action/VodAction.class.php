...
class VodAction extends BaseAction{
    ...
    public function show(){
		...
		foreach($list as $key=>$val){
			...
			$list[$key]['vod_url'] = ff_data_url('vod',$list[$key]['vod_id'],$list[$key]['vod_cid'],$list[$key]['vod_name'],1,$list[$key]['vod_jumpurl'],$list[$key]['vod_pinyin']);
